      ...
      <header className="encabezado">
        ...
        <main class ="holder-contacto">
          ...
          <form class="formulario" action="/contacto" method="post" onSubmit={handleSubmit}>
            ...
            <p>
              <label for="address">Address (including postcode and state)</label>
              <input type="text" name="address" value={formData.address} onChange={handleChange} />
            </p>
            <p>
            <label for="clothingtypes">Clothing Types:</label>
            <input type="text" name="clothingtypes" value={formData.clothingtypes} onChange={handleChange} />
            <select id="clothingtypes" name="clothingtypes" multiple required>
            <option value="dress">Dress</option>
            <option value="ethnicWear">Ethnic Wear - Sari / Blouse</option>
            </select>
            </p>
            <p>
            <label for="images">Upload Images:</label>
            <input type="file" id="images" name="images" accept="image/*" multiple required value={formData.images} onChange={handleChange}/>
            </p>
            <p>
